...
Cleaning and tidying the Cleveland Heart Disease dataset. 
```{r}
...
Run a single classification tree using all of the features available in the dataset. Calculate evaluation metrics and output the variable importance metrics.
...
Use random forest to classify heart disease. Set up a pipeline to try different values of mtry and different numbers of trees to obtain your optimal model. Again, calculate appropriate evaluation metrics and output the variable importance metrics.
...
## Number 4
Answer the questions: Are there differences in variable importance that you see between a single tree and an ensemble metric? Are there differences observed across the different variable importance metrics output from the ensemble? How do you interpret those differences?
